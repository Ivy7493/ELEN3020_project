...
def ViewSamples(conn, _boxID, _fridgeID, _collectionTitle):
    ...
    cols = ('ID', 'Box ID', 'X', 'Y' , 'Z', 'Type', 'Origin Country', 'Collection Date', 'Entry Date', 'Subject Age', 'Tube Rating', 'Collection Title', 'Return Type', 'Return Date', 'Phenotype', 'Disease State')
    ...
    tree.column("Collection Title", minwidth=0, width=100, stretch=tk.NO)
    tree.column("Return Type", minwidth=0, width=90, stretch=tk.NO)
    tree.column("Return Date", minwidth=0, width=100, stretch=tk.NO)
    tree.column("Phenotype", minwidth=0, width=80, stretch=tk.NO)
    tree.column("Disease State", minwidth=0, width=80, stretch=tk.NO)

...
def ViewSamples(conn, _boxID, _fridgeID, _collectionTitle):
    ...
    tree.column("ID", minwidth=0, width=40, stretch=NO)
    ...
    tree.column("Type", minwidth=0, width=50, stretch=NO)
    tree.column("Origin Country", minwidth=0, width=120, stretch=NO)
    tree.column("Collection Date", minwidth=0, width=128, stretch=NO)
    tree.column("Entry Date", minwidth=0, width=85, stretch=NO)
    tree.column("Subject Age", minwidth=0, width=100, stretch=NO)
    tree.column("Tube Rating", minwidth=0, width=100, stretch=NO)
    tree.column("Collection Title", minwidth=0, width=130, stretch=NO)
    tree.column("Return Type", minwidth=0, width=100, stretch=NO)
    tree.column("Return Date", minwidth=0, width=100, stretch=NO)
    tree.column("Phenotype Value", minwidth=0, width=130, stretch=NO)
    tree.column("Disease State", minwidth=0, width=105, stretch=NO)

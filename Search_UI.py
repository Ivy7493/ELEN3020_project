...
def SearchSample_Window(conn):
    ...
    ReturnButton = tk.Button(window_SampleSearch, text='Back to Search Menu', command=Open_MainMenu_Window, font = myFont).grid(row=16, column=2)
	#-------------------------------

    tk.Label(window_SampleSearch, height = 1, width = 2, bg="cadet blue").grid(row =0, column =0)
    tk.Label(window_SampleSearch, height = 1, width = 2, bg="cadet blue").grid(row =15, column =0)
    tk.Label(window_SampleSearch, height = 1, width = 2, bg="cadet blue").grid(row =17, column =4)
